# catalogo-service-mvc — Produtos e Categorias
...
```bash
cd microsservicos/catalogo-service-mvc
...
### DynamoDB
- `tcc-mvc-catalogo-categorias` (PK: id)
- `tcc-mvc-catalogo-produtos` (PK: id)
- SNS: `tcc-mvc-catalogo-eventos`
