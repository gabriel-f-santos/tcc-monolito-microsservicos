# catalogo-service — Produtos e Categorias
...
```bash
cd microsservicos/catalogo-service
...
### DynamoDB
- `tcc-ddd-catalogo-categorias` (PK: id)
- `tcc-ddd-catalogo-produtos` (PK: id)
- SNS: `tcc-ddd-catalogo-eventos`

### Cross-Stack References
- `tcc-ddd-auth-authorizer-arn` — Lambda Authorizer do auth-service
- `tcc-ddd-catalogo-eventos-topic-arn` — Topic SNS (usado pelo estoque)
