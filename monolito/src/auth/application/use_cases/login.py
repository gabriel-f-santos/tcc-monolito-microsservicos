...
from src.auth.domain.exceptions.auth import CredenciaisInvalidas
from src.auth.domain.repositories.usuario_repository import UsuarioRepository
from src.auth.domain.services.password_hasher import PasswordHasher
...
class LoginUseCase:
    def __init__(self, repo: UsuarioRepository, hasher: PasswordHasher, token_service: TokenService) -> None:
        self.repo = repo
        self.hasher = hasher
